...
//属性点击事件
function property_click(obj, suffix, value) {
    var name = $(obj).attr('name');
...
//描叙点击事件
function item_click(obj, suffix, value) {
    var name = $(obj).attr('name');
    var current_class = $(obj).attr('class');


    var total = "" + $("#property_" + suffix).val();
